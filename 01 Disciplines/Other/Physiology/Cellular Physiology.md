...
- Organelles
	...
	- Endoplasmic reticulum
		...
		- Smooth ER is for steroid and lipid synthesis; therefore more prominent in cells of the adrenal cortex for example
			- In smooth muscles it is known as the sarcoplasmic reticulum and serves as a intracellular store of $\ce{Ca^{2+}}$ hat releases $\ce{Ca^{2+}}$ following depolarisation
	- Golgi apparatus
