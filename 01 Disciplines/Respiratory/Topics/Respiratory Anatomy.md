...
# Lower Airways
## Larynx
- During exhalation, the vocal cords are adducted slightly to create resistance to flow ⇒ positive end expiratory pressure of 3-4cm$\ce{H2O}$ (physiological PEEP) ⇒ prevents alveolar collapse and maintains functional residual capacity
	- During intubation, patients can no longer adduct their vocal cords and can’t maintain physiological PEEP ⇒ atelactasis and $\dot{V}/\dot{Q}$ mismatch; it is therefore common to apply extrinsic PEEP ($\text{PEEP}_\text{e}$) at physiologic levels (3-5 cm$\ce{H2O}$) to maintain FRC and prevent atelactasis following intubation
...
- Bronchioles
	...
	- $\beta_2$ agonists and anticholinergics cause bronchodilation
- Alveoli
