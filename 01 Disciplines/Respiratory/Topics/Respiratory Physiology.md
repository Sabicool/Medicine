...
$$
\begin{align*}
\ce{O2}\ \text{content per}\ 100\ \text{mL of blood}&=\underbrace{\underset{\text{Hüfner's constant}}{1.34}\times\ce{[Hb]}\times\frac{S_\text{a}\ce{O2}}{100\%}}_{\ce{O2}\ \text{bound to haemoglobin}}+\underbrace{\underset{\text{Solubility constant}}{0.023}\times P_\text{a}\ce{O2}}_{\ce{O2}\ \text{dissolved in blood}}\\
&\approx19.8\ \text{mL for typical arterial blood}
\end{align*}
$$
...
- Haemoglobin has a preference to be either fully saturated or desaturated due to cooperativity
	- Cooperative binding is the increase in $\ce{O2}$ affinity of Hb with each successive $\ce{O2}$ binding
...
- Physiological
	...
	- $\ce{HbF}$: normal variant during feotal life and has a higher affinity for $\ce{O2}$ ($\ce{\alpha 2\gamma 2}$)
- Pathological
	- $\ce{HbS}$: in sickle cell disease which has an abnormal $\beta$-globin subunit
	- $\ce{MetHb}$: Methaemoglobinaemia is where the ferrous iron within the Hb molecule is oxidised to ferric iron ($\ce{Fe^3+}$); $\ce{Fe^3+}$ cannot bind to $\ce{O2}$, so $\ce{MetHb}$ cannot participate in $\ce{O2}$ transport
		- Low level of $\ce{MetHb}$ is maintained by:
			...
			- $\ce{MetHb}$ reductase/nicotinamide adenine dinucleotide (NADH) system reduces ferric iron by a reduction system involving $\ce{MetHb}$ reductase
		...
		- Pulse oximeters misread $\ce{MetHb}$ and display values of 85% irrespective of $\ce{MetHb}$ concentration
